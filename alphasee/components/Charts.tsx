...
function CustomTooltip1({ active, payload, label }: any) {
  ...
  return (
    <div style={{ background: "var(--tooltip-bg)", border: "1px solid var(--border)", borderRadius: 8, padding: "8px 12px", fontSize: 12 }}>
      <div style={{ fontFamily: "Roboto Mono", color: "var(--purple-dark)", marginBottom: 4 }}>
        {fmtDollar(d.val)}
      </div>
          ...
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={growthData} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
              ...
              <YAxis
                ...
                tick={{ fontSize: 10, fill: "var(--text-muted)", fontFamily: "Roboto Mono" }}
                width={48}
              />
